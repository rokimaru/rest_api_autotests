...
class TestDogSite:
    ...
    def test_dogsite_number_of_breeds_1(self):
        ...
        assert len(DogSiteMethods.get_all_breeds()) == 92
    ...
    @pytest.mark.parametrize('breed_list', DogSiteMethods.get_all_breeds())
    def test_dogsite_random_image_for_breed_4(self, breed_list):
        ...
        response = DogSiteMethods.request_breed_image(breed_list)
